...
namespace MagazynApp.Controllers
{
    ...
    public class SuppliesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string filter)
        {
            ...
            {
                "Uncompleted" => View(await _supplyRepository.SupplyUncompleted()),
                "Completed" => View(await _supplyRepository.SupplyCompleted()),
                _ => View(await _supplyRepository.SupplyToListAsync())
            };
        }
